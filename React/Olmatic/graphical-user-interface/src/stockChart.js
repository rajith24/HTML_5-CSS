    ...
    render(){
      ...
      var name = this.props.filename
        ...
        const options = {
          ...
          // };
          return (
            <div className="stock_size">
            <Button title="CSV Save" data-toggle="tooltip" data-placement="bottom" className="position csv btn btn-sm btn-dark" onClick={downloadCSV}>
